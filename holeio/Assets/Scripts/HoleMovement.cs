...
public class HoleMovement : MonoBehaviour
{
	...
	void MoveHole ()
	{
		x = Input.mousePosition.x; //Input.GetAxis ("Mouse X");
		y = Input.mousePosition.y; //Input.GetAxis ("Mouse Y");
	...
	void OnDrawGizmos ()
	{
		...
		for (int i = 0; i < meshFilter.mesh.vertices.Length - 1; i++)
		{
			Gizmos.DrawWireSphere(meshFilter.mesh.vertices[i], 1);
		}
	}
}
